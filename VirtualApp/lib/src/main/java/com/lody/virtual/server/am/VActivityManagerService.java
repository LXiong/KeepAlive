...
public class VActivityManagerService extends IActivityManager.Stub {
    ...
    public int startActivity(Intent intent, ActivityInfo info, IBinder resultTo, Bundle options, String resultWho, int requestCode, int userId) {
        DebugTool.i(TAG+"==startActivity==intent=="+intent);
        DebugTool.i(TAG+"==startActivity==resultWho=="+resultWho);
        DebugTool.i(TAG+"==startActivity==requestCode=="+requestCode);
        DebugTool.i(TAG+"==startActivity==userId=="+userId);
...
//            intent.setAction()
    ...
    public String getCallingPackage(int userId, IBinder token) {
        DebugTool.i(TAG+"==getCallingPackage=="+userId);
...
//        VNotificationManager.get().dealNotification(id, notification, pkg);
    ...
    private String getProcessName(int pid) {
        DebugTool.i(TAG+"==getProcessName==pid:"+pid);
    ...
    public int getUidByPid(int pid) {
        synchronized (mPidsSelfLocked) {
            DebugTool.i(TAG+"==getUidByPid==pid:"+pid);
    ...
    private ProcessRecord performStartProcessLocked(int vuid, int vpid, ApplicationInfo info, String processName) {
        DebugTool.i(TAG+"==performStartProcessLocked==vuid:"+vuid+"==vpid:"+vpid+"==processName:"+processName);
    ...
    public void sendBroadcastAsUser(Intent intent, VUserHandle user, String permission) {
        ...
        // TODO: checkPermission
        DebugTool.i(TAG+"==sendBroadcastAsUser=="+permission);
        DebugTool.i(TAG+"==sendBroadcastAsUser=="+intent.getAction());
        context.sendBroadcast(intent);
    }
    ...
    private boolean handleUserBroadcast(int vuid, ActivityInfo info, ComponentName component, Intent realIntent, PendingResultData result) {
        DebugTool.i(TAG+"==handleUserBroadcast=="+vuid);
