...
public class BinderInvocationStub extends MethodInvocationStub<IInterface> implements IBinder {
    ...
    private static IInterface asInterface(Class<?> stubClass, IBinder binder) {
        ...
        try {
            ...
            DebugTool.i(TAG+"==asInterface=EX=" + stubClass.getName() + ". Cause: " + e);
            return null;
        }
    }

    public void replaceService(String name) {
        DebugTool.i(TAG+"==replaceService=="+name);
        if (mBaseBinder != null) {
    ...
    private final class AsBinder extends MethodProxy {
        ...
        private  final String TAG=AsBinder.class.getSimpleName();
        @Override
    ...
    public String getInterfaceDescriptor() throws RemoteException {
        DebugTool.i(TAG+"==getInterfaceDescriptor=="+mBaseBinder.getInterfaceDescriptor());
    ...
    public IInterface queryLocalInterface(String descriptor) {
        DebugTool.i(TAG+"==queryLocalInterface=="+descriptor);
