...
public class MethodParameterUtils {
	...
	public static String replaceFirstAppPkg(Object[] args) {
		...
		DebugTool.i("MethodParameterUtils==replaceFirstAppPkg=="+args);
		if(args!=null){
			for (int i=0;i<args.length;i++){
				if(args[i]==null)
					continue;
				DebugTool.i("MethodParameterUtils==replaceFirstAppPkg=="+args[i].getClass().getSimpleName());
				DebugTool.i("MethodParameterUtils==replaceFirstAppPkg=="+args[i]);
			}
		}
