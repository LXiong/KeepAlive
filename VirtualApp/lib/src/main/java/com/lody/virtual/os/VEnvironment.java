...
public class VEnvironment {
    ...
    public static File getPackageListFile() {
        DebugTool.i(TAG+"==getPackageListFile=="+getSystemSecureDirectory()+"packages.ini");
    ...
    public static File getPackageCacheFile(String packageName) {
        DebugTool.i("==getPackageCacheFile=="+getDataAppPackageDirectory(packageName)+packageName);
