...
public class ProviderHook implements InvocationHandler {
    ...
    private static final String TAG=ProviderHook.class.getSimpleName();
    ...
    private static HookFetcher fetchHook(String authority) {
        DebugTool.i(TAG+"==fetchHook=="+authority);
    ...
    public static IInterface createProxy(boolean external, String authority, IInterface provider) {
        DebugTool.i(TAG+"==createProxy=="+authority);
    ...
    public Bundle call(MethodBox methodBox, String method, String arg, Bundle extras) throws InvocationTargetException {
        DebugTool.i(TAG+"==call=="+methodBox.method+"=="+method);
    ...
    public Object invoke(Object proxy, Method method, Object... args) throws Throwable {
        try {
            ...
            e.printStackTrace();
            DebugTool.i(TAG+"==invoke=1="+e.getMessage());
        }
        ...
        try {
            ...
            DebugTool.i(TAG+"==invoke=2="+e.getMessage());
    ...
    protected void processArgs(Method method, Object... args) {
        DebugTool.i(TAG+"==processArgs=="+method.getName());
    }
