...
abstract class StubBinder implements IBinder {
	...
	public IInterface queryLocalInterface(String descriptor) {
		DebugTool.i("StubBinder==queryLocalInterface=="+descriptor);
		if (mInterface == null) {
			...
			for (StackTraceElement element : stackTrace) {
				...
				try {
                    ...
                    if ((method.getModifiers() & Modifier.STATIC) != 0) {
						...
						DebugTool.i("StubBinder==queryLocalInterface==method:"+method.getName());
                        Class<?> returnType = method.getReturnType();
						DebugTool.i("StubBinder==queryLocalInterface==returnType:"+returnType.getSimpleName());
