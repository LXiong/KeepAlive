...
public class PackageParserEx {
    ...
    public static VPackage parsePackage(File packageFile) throws Throwable {
        DebugTool.i(TAG+"==parsePackage=="+packageFile.getAbsolutePath());
    ...
    private static VPackage buildPackageCache(PackageParser.Package p) {
        DebugTool.i(TAG+"==buildPackageCache==");
        ...
        for (String permissionName: cache.requestedPermissions){
            DebugTool.i(TAG+"==buildPackageCache==addPermissionName=="+permissionName);
        }
    ...
    public static PermissionInfo generatePermissionInfo(
        ...
        if (p == null) return null;
        DebugTool.i(TAG+"==generatePermissionInfo=="+p.info);
        if ((flags & PackageManager.GET_META_DATA) == 0) {
            return p.info;
        }
        PermissionInfo pi = new PermissionInfo(p.info);
        DebugTool.i(TAG+"==generatePermissionInfo=="+p.metaData);
        pi.metaData = p.metaData;
        return pi;
    }
    ...
    public static PermissionGroupInfo generatePermissionGroupInfo(
        ...
        DebugTool.i(TAG+"==generatePermissionGroupInfo=="+pg.info);
        if ((flags & PackageManager.GET_META_DATA) == 0) {
            return pg.info;
        }
        PermissionGroupInfo pgi = new PermissionGroupInfo(pg.info);
        DebugTool.i(TAG+"==generatePermissionGroupInfo=="+pg.metaData);
