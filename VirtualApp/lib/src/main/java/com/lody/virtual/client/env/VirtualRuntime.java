...
public class VirtualRuntime {
    ...
    private static final String TAG=VirtualRuntime.class.getSimpleName();
    ...
    public static void setupRuntime(String processName, ApplicationInfo appInfo) {
        DebugTool.i(TAG+"==setupRuntime=="+processName);
    ...
    public static <T> T crash(RemoteException e) throws RuntimeException {
        DebugTool.i(TAG+"==crash=="+e.getMessage());
        e.printStackTrace();
    ...
    public static boolean isArt() {
        DebugTool.i(TAG+"==isArt=="+System.getProperty("java.vm.version").startsWith("2"));
