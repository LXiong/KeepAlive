...
class MethodProxies {
    ...
    static class GetPackageUid extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            DebugTool.i("GetPackageUid==call=="+who);
            DebugTool.i("GetPackageUid==call=="+method.getName());
            DebugTool.i("GetPackageUid==call=="+args);
            ...
            return Proxy.newProxyInstance(installer.getClass().getClassLoader(), installer.getClass().getInterfaces(),
                    new InvocationHandler() {
                        ...
                        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                            DebugTool.i("GetPackageUidEtc==call=="+method.getName());
                            switch (method.getName()) {
                                ...
                                case "setPermissionsResult": {
                                    DebugTool.i("GetPackageUidEtc==call=="+method.getName()+"==setPermissionsResult==");
                                    int sessionId = (int) args[0];
    ...
    static class GetPackageGids extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("GetPackageGids==call=="+who);
            DebugTool.i("GetPackageGids==call=="+method.getName());
            DebugTool.i("GetPackageGids==call=="+args);
    ...
    static class RevokeRuntimePermission extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("RevokeRuntimePermission==call=="+who);
            DebugTool.i("RevokeRuntimePermission==call=="+method.getName());
            DebugTool.i("RevokeRuntimePermission==call=="+args);
    ...
    static class GetPermissions extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("GetPermissions==call=="+who);
            DebugTool.i("GetPermissions==call=="+method.getName());
            DebugTool.i("GetPermissions==call=="+args);
    ...
    static class GetPermissionGroupInfo extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("GetPermissionGroupInfo==call=="+who);
            DebugTool.i("GetPermissionGroupInfo==call=="+method.getName());
            DebugTool.i("GetPermissionGroupInfo==call==" + args);
    ...
    //---------------test start--------------------
    static class GrantRuntimePermission extends MethodProxy{
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("==PM==grantRuntimePermission==call=="+args);
            return null;
        }
    }

    static class GrantRuntimePermissionsLPw extends MethodProxy{

        @Override
        public String getMethodName() {
            return "grantRuntimePermissionsLPw";
        }

        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("==PM==grantRuntimePermissionsLPw==call=="+args);
            return null;
        }
    }
    //---------------test end--------------------
    ...
    static class CheckPermission extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("==PM==checkPermission==call==");
            DebugTool.i("==PM==checkPermission==call=="+who);
            DebugTool.i("==PM==checkPermission==call=="+method.getName());
            DebugTool.i("==PM==checkPermission==call=="+args);

            String permName = (String) args[0];
            String pkgName = (String) args[1];
            int userId = VUserHandle.myUserId();
            if(permName.contains("CAMERA")){
                DebugTool.i("==PM==相机==denied==");
    ...
    static class GetPackagesForUid extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("GetPackagesForUid==call=="+who);
            DebugTool.i("GetPackagesForUid==call=="+method.getName());
            DebugTool.i("GetPackagesForUid==call=="+args);
    ...
    static class getNameForUid extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("getNameForUid==call=="+who);
            DebugTool.i("getNameForUid==call=="+method.getName());
            DebugTool.i("getNameForUid==call=="+args);
    ...
    static class ResolveIntent extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("ResolveIntent==call=="+who);
            DebugTool.i("ResolveIntent==call=="+method.getName());
            DebugTool.i("ResolveIntent==call=="+args);
    ...
    static class GetPermissionFlags extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("GetPermissionFlags==call=="+who);
            DebugTool.i("GetPermissionFlags==call=="+method.getName());
            DebugTool.i("GetPermissionFlags==call=="+args);
