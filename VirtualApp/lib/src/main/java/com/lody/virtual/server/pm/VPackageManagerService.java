...
public class VPackageManagerService extends IPackageManager.Stub {
    ...
    static final String TAG = VPackageManagerService.class.getSimpleName();
    ...
    void analyzePackageLocked(VPackage pkg) {
        DebugTool.i(TAG+"==analyzePackageLocked");
    ...
    public int checkPermission(String permName, String pkgName, int userId) {
        DebugTool.i(TAG+"==checkPermission=="+permName+"=="+pkgName+"=="+userId);
    ...
    @Override
    public void grantRuntimePermission(String packageName, String name, int userId) throws RemoteException {
        DebugTool.i(TAG+"==grantRuntimePermission=="+packageName+"=="+name+"=="+userId);
    }
    ...
    private void checkUserId(int userId) {
        DebugTool.i(TAG+"==checkUserId=="+userId);
    ...
    public PermissionInfo getPermissionInfo(String name, int flags) {
        synchronized (mPackages) {
            DebugTool.i(TAG+"==getPermissionInfo=="+name);
    ...
    public List<PermissionInfo> queryPermissionsByGroup(String group, int flags) {
        synchronized (mPackages) {
            DebugTool.i(TAG+"==queryPermissionsByGroup=="+group);
            return null;
        }
    }
    ...
    public PermissionGroupInfo getPermissionGroupInfo(String name, int flags) {
        synchronized (mPackages) {
            DebugTool.i(TAG+"==getPermissionGroupInfo=="+name);
    ...
    public List<PermissionGroupInfo> getAllPermissionGroups(int flags) {
        synchronized (mPackages) {
            DebugTool.i(TAG+"==getAllPermissionGroups==");
    ...
    public String[] getPackagesForUid(int uid) {
        ...
        DebugTool.i(TAG+"==getPackagesForUid=="+uid);
        checkUserId(userId);
        synchronized (this) {
    ...
    public int getPackageUid(String packageName, int userId) {
        DebugTool.i(TAG+"==getPackageUid=="+packageName+"=="+userId);
        checkUserId(userId);
        synchronized (mPackages) {
            VPackage p = mPackages.get(packageName);
            if (p != null) {
    ...
    public String getNameForUid(int uid) {
        DebugTool.i(TAG+"==getNameForUid=="+uid);
    ...
    public IPackageInstaller getPackageInstaller() {
        DebugTool.i(TAG+"==getPackageInstaller==");
