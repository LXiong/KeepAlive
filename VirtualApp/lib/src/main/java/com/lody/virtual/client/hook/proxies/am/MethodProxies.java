...
class MethodProxies {
    ...
    static class GetIntentSender extends MethodProxy {
        ...
        private Intent redirectIntentSender(int type, String creator, Intent intent) {
            ...
            DebugTool.i(getMethodName()+"==redirectIntentSender=="+creator);
    ...
    static class StartActivity extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("==StartActivity==Proxy==call==who:"+who);
            if(args!=null){
                for (int i=0;i<args.length;i++){
                    DebugTool.i("==StartActivity==Proxy==call==args:type:"+args[i]);
                    DebugTool.i("==StartActivity==Proxy==call==args:value:"+args[i]);
                    if(args[i] instanceof Intent){
                        Intent in= (Intent) args[i];
                        String[] perNames= (String[]) in.getCharSequenceArrayExtra("android.content.pm.extra.REQUEST_PERMISSIONS_NAMES");
                        if(perNames!=null){
                            for (int j=0;j<perNames.length;j++){
                                DebugTool.i("==StartActivity==Proxy==perNames=="+perNames[j]);
                                if(perNames.equals("android.permission.CAMERA")){
                                    perNames[j]="android.permission.XYZ";
                                    DebugTool.i("==StartActivity==Proxy==call==");
                                    in.putExtra("android.content.pm.extra.REQUEST_PERMISSIONS_NAMES",perNames);
                                }
                            }
                        }
                        args[i]=in;
            ...
            for (int i=0;i<ss.length;i++){
                DebugTool.i("==StartActivity==Proxy==strace=="+ss[i]);
            }
    ...
    static class GetCallingPackage extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("GetCallingPackage==call=="+who);
            DebugTool.i("GetCallingPackage==call=="+method.getName());
            DebugTool.i("GetCallingPackage==call=="+args);
    ...
    static class PublishContentProviders extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("PublishContentProviders==call=="+who);
            DebugTool.i("PublishContentProviders==call=="+method.getName());
            DebugTool.i("PublishContentProviders==call=="+args);
    ...
    static class GrantUriPermissionFromOwner extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            DebugTool.i("GrantUriPermissionFromOwner==call=="+who);
            DebugTool.i("GrantUriPermissionFromOwner==call=="+method.getName());
            DebugTool.i("GrantUriPermissionFromOwner==call=="+args);
    ...
    static class PublishService extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            DebugTool.i("PublishService==call=="+who);
            DebugTool.i("PublishService==call=="+method.getName());
            DebugTool.i("PublishService==call=="+args);
    ...
    static class StartActivityAsUser extends StartActivity {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("AM==startActivityAsUser==call=="+args);
            return super.call(who, method, args);
        }
    }
    ...
    static class CheckPermission extends MethodProxy {
        ...
        public Object call(Object who, Method method, Object... args) throws Throwable {
            ...
            DebugTool.i("AM==checkPermission==call=="+permission);
            DebugTool.i("AM==checkPermission==call=="+who);
            DebugTool.i("AM==checkPermission==call=="+method.getName());
            DebugTool.i("AM==checkPermission==call=="+args);

            if(permission.contains("CAMERA")){
                //在业务层拒绝相机权限
                DebugTool.i("AM==checkPermission==call==在业务层拒绝相机权限："+permission);
                DebugTool.i("AM==checkPermission==call==在业务层拒绝相机权限：包名："+getAppPkg());

                StackTraceElement[]strace=Thread.currentThread().getStackTrace();
                for(StackTraceElement t:strace){
                    DebugTool.i("AM=="+t.toString());
                }
                //通过时，不会弹授权框而直接调相机
                //不通过时，弹授权框
    ...
    static class GetPersistedUriPermissions extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("GetPersistedUriPermissions==call=="+who);
            DebugTool.i("GetPersistedUriPermissions==call=="+method.getName());
            DebugTool.i("GetPersistedUriPermissions==call=="+args);
    ...
    static class BroadcastIntent extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i(getMethodName()+"==call==");
            Intent intent = (Intent) args[1];
        ...
        private Intent handleIntent(final Intent intent) {
            ...
            DebugTool.i(getMethodName()+"==handleIntent=="+action);
    ...
    static class CheckGrantUriPermission extends MethodProxy {
        ...
        @Override
        public Object call(Object who, Method method, Object... args) throws Throwable {
            DebugTool.i("CheckGrantUriPermission==call=="+who);
            DebugTool.i("CheckGrantUriPermission==call=="+method.getName());
            DebugTool.i("CheckGrantUriPermission==call=="+args);
